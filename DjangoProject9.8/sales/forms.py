...
from .models import VentaMedicamento, TransferenciaMedicamento, Pedido, DetallePedido, Sucursal
from django.forms.models import inlineformset_factory


class VentaMedicamentoForm(forms.ModelForm):
    class Meta:
        model = VentaMedicamento
        fields = ['cliente', 'medicamento_sucursal', 'cantidad', 'tipo_entrega']


class TransferenciaMedicamentoForm(forms.ModelForm):
    class Meta:
        model = TransferenciaMedicamento
        fields = ['medicamento_sucursal_origen', 'medicamento_sucursal_destino', 'cantidad']
